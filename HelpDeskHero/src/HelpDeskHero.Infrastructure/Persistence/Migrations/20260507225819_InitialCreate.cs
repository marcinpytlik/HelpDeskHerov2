        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentOrganizationUnitId = table.Column<int>(type: "int", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowDefinitions_TicketTypes_TicketTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueResponseAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_OrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_OrganizationUnitId",
                table: "Tickets",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TenantId_AssignedToUserId_CreatedAtUtc",
                table: "Tickets",
                columns: new[] { "TenantId", "AssignedToUserId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TenantId_WorkflowStateId_CreatedAtUtc",
                table: "Tickets",
                columns: new[] { "TenantId", "WorkflowStateId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketTypes_TenantId_Code",
                table: "TicketTypes",
                columns: new[] { "TenantId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowDefinitions_TenantId_TicketTypeId_Code",
                table: "WorkflowDefinitions",
                columns: new[] { "TenantId", "TicketTypeId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowDefinitions_TicketTypeId",
                table: "WorkflowDefinitions",
                column: "TicketTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowStates_WorkflowDefinitionId_SortOrder",
                table: "WorkflowStates",
